        ...
        <div class="sb2-2">
            ...
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="<?php echo base_url() ?>admin/dashboard"> Dashboard</a>
                    </li>
                    <li class="page-back"><a href="<?php echo base_url() ?>"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                    </li>
                </ul>
            </div>
            <!--== DASHBOARD INFO ==-->
                            ...
                            <div class="tab-inn">
                                <div class="table-responsive table-desi">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/user/1.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/user/2.png" alt=""></span>
                                                </td>
                                                <td><a href="#"><span class="list-enq-name">Marsha Hogan</span><span class="list-enq-city">Illunois, United States</span></a>
                                                </td>
                                                <td>+01 3214 6522</td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/user/3.png" alt=""></span>
                                                </td>
                                                <td><a href="#"><span class="list-enq-name">Marsha Hogan</span><span class="list-enq-city">Illunois, United States</span></a>
                                                </td>
                                                <td>+01 3214 6522</td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/user/4.png" alt=""></span>
                                                </td>
                                                <td><a href="#"><span class="list-enq-name">Marsha Hogan</span><span class="list-enq-city">Illunois, United States</span></a>
                                                </td>
                                                <td>+01 3214 6522</td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/user/5.png" alt=""></span>
                                                </td>
                                                <td><a href="#"><span class="list-enq-name">Marsha Hogan</span><span class="list-enq-city">Illunois, United States</span></a>
                                                </td>
                                                <td>+01 3214 6522</td>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/listing/1.jpg" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/listing/2.jpg" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/listing/3.jpg" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/listing/4.jpg" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/listing/5.jpg" alt=""></span>
                                                </td>
                            ...
                            <div class="tab-inn">
                                <div class="table-responsive table-desi">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/1.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/2.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/3.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/4.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/5.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/6.png" alt=""></span>
                                                </td>
                                            ...
                                            <tr>
                                                <td><span class="list-img"><img src="<?php echo $this->config->item('admin_assets_url') ?>images/sm/7.png" alt=""></span>
                                                </td>
