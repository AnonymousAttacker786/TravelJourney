<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog sb2-2-1">
        <div class="box-inn-sp">
            ...
            <form id="tour_package_add_step3" action="<?php echo base_url() ?>admin/tour_package/save_step3" method="post">
                <div class="tab-inn">

                    <div class="row">
                        <div class="input-field col s10">
                            <input id="list-title" type="text" name="pickup_location[]" class="validate" >
    ...
    $(document).ready(function () {
        $('.addButton').on('click', function () {
            ...
            var template = $(this).attr('data-template'),
                    ...
                    $el = $row.find('input').eq(0).attr('name','pickup_location' + '[]');
